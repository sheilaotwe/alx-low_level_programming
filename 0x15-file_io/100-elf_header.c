...
/**
 * check_elf - function that checks if file is an ELF file
...
/**
 * print_class - Function that prints class of an ELF header
...
/**
 * print_version - Function that prints the version of ELF header
...
/**
 * print_abi - Function that prints the ABI version of ELF header
 ...
 * @elf: file descripter of ELF file
...
/**
 * main - function the display information contained in ELF header at file start
